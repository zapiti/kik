...
import 'package:kik/screen/main/home/home_screen.dart';
import 'package:kik/screen/main/setting/settings_screen.dart';
import 'package:kik/screen/main/transaction/transaction_history_screen.dart';
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: CustomBottomNavBar(
          ...
          selectedItemIcon: const [
            ImageUtils.homeFill,
            ImageUtils.receiptFill,
            ImageUtils.settingFill
          ],
          unselectedItemIcon: const [
            ImageUtils.homeOutlined,
            ImageUtils.receiptOutlined,
            ImageUtils.settingOutLined
          ],
          label: const ["Inicio", "Agendamentos", "Configuraçoes"],
          onChange: (val) {
            setState(() {
              _currentIndex = val;
            });
