...
import '../widget/Cleaner_field_list.dart';

class SearchScreen extends StatefulWidget {
  String selectedDropdownItem;
  List<CleanerField> fieldList = cleanerFieldList;
...
class _SearchScreenState extends State<SearchScreen> {
  String _query = "";
  String _selectedDropdownItem = "Todos";
  List<CleanerField> _fieldList = [];
  List<CleanerField> _selectedListByCategory = [];
  ...
  void initState() {
    ...
    if (_query != "") {
      ...
      for (int i = 0; i < _fieldList.length; i++) {
        if (_selectedDropdownItem == "Todos") {
              ...
              children: [
                ...
                Column(
                    children: _selectedListByCategory
                        .map((fieldEntity) => CleanerFieldList(
                              field: fieldEntity,
                            ))
                        .toList())
              ],
